import styles from './articles_news.module.css';
...
import { ArticleContainerNews } from '../article-container/article-container-news';
...
export const ArticlesNews = () => {
	...
	useEffect(() => {
		setLoading(true);
		request(
			`/newsarticles?search=${searchPhrase}&page=${page}&limit=${PAGINATION_LIMIT}`,
